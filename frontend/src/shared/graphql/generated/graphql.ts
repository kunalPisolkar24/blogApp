...
export type PostDraftFieldsFragment = { __typename?: 'PostDraft', id: string, approvalId: string, prompt: string, title: string, body: string, summary: string, tags: Array<string>, status: DraftStatus, authorId: string, postId?: string | null, createdAt: string, updatedAt: string };

export type PaginatedPostDraftFieldsFragment = { __typename?: 'PaginatedPostDrafts', totalPages: number, currentPage: number, totalDrafts: number, drafts: Array<{ __typename?: 'PostDraft', id: string, approvalId: string, prompt: string, title: string, body: string, summary: string, tags: Array<string>, status: DraftStatus, authorId: string, postId?: string | null, createdAt: string, updatedAt: string }> };
...
export type CreatePostDraftMutation = { __typename?: 'Mutation', createPostDraft: { __typename?: 'PostDraft', id: string, approvalId: string, prompt: string, title: string, body: string, summary: string, tags: Array<string>, status: DraftStatus, authorId: string, postId?: string | null, createdAt: string, updatedAt: string } };
...
export type ApprovePostDraftMutation = { __typename?: 'Mutation', approvePostDraft: { __typename?: 'PostDraft', id: string, approvalId: string, prompt: string, title: string, body: string, summary: string, tags: Array<string>, status: DraftStatus, authorId: string, postId?: string | null, createdAt: string, updatedAt: string } };
...
export type RejectPostDraftMutation = { __typename?: 'Mutation', rejectPostDraft: { __typename?: 'PostDraft', id: string, approvalId: string, prompt: string, title: string, body: string, summary: string, tags: Array<string>, status: DraftStatus, authorId: string, postId?: string | null, createdAt: string, updatedAt: string } };
